...
d["identity"]=100*(17-d.subs_vs_canonical)/17          # % identity to canonical motif
...
CM="YlOrRd"; VMIN,VMAX=70,100                          # identity colour scale
...
bench(a1)
a1.set_xlim(0,2); a1.set_ylim(0,2); a1.set_xlabel("flank information (bits) — control"); a1.set_ylabel("box-motif information (bits)")
...
a2.set_xlim(0,2); a2.set_ylim(0,2); a2.set_xlabel("flank information (bits) — control"); a2.set_ylabel("box-motif information (bits)")
a2.set_title("Vertebrates (size ∝ candidate boxes/Mbp)",fontsize=8.5,fontweight="bold",pad=3)
a2.text(0.03,0.97,"candidate box =\nhigh identity + above diagonal",transform=a2.transAxes,fontsize=6.2,color="0.35",va="top")
